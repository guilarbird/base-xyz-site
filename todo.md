# Base XYZ Landing Page - TODO

## Funcionalidades

- [x] Hero section com título, subtítulo e CTAs
- [x] Seção "Desafio da Garrafa" (ritual de entrada)
- [x] Seção "O Que é a Base XYZ"
- [x] Seção "Como Funciona" (jornada do membro)
- [x] Seção "FAQ"
- [x] CTA Final
- [x] Footer com links e redes sociais
- [x] Design responsivo (mobile-first)
- [x] Identidade visual (roxo primário, tema escuro)
- [x] Logo do Base XYZ
...
## Refinamento da Seção Jornada

- [x] Aplicar paleta de cores específica (#E6E6E6, #9E9E9E, #C7C7C7)
- [x] Adicionar gradient de fundo (#0C0C0C → #0A0A0A)
- [x] Adicionar glow cinematográfico atrás do título (radial-gradient roxo 10%)
- [x] Ajustar espaçamentos verticais (mb-6, mb-8, mb-10)

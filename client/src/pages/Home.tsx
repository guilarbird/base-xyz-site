            ...
            <div className="max-w-5xl mx-auto">
              ...
              >
                ...
                <p 
                  ...
                  style={{ color: '#A1A1A1', marginTop: '24px' }}
                >
                  Conectando creators, builders e investidores que estão moldando o futuro da economia digital
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    description: "Cursos, cases e análises sobre stablecoins, DeFi, pagamentos cross-border e economia digital"
                  },
                  {
                    icon: Palette,
